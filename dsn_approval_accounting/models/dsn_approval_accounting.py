...
#  ================================\approval\========================================>
class DsnApprovalAccounting(models.Model):
    _name = "dsn.approval.accounting"
    _description = "DSN Approval Accounting"
    _rec_name = 'reference'
    ...
    user_ids = fields.One2many('dsn.approval.accounting.user.line', 'approval_accounting_id', string='Approver')
    job_ids = fields.One2many('dsn.accounting.approval.job.line', 'approval_accounting_id', string='Job Position')
...
#  ================================\user ids\========================================>
class DsnApprovalAccountingUserLine(models.Model):
    _name = "dsn.approval.accounting.user.line"
    _description = "DSN Accounting Approval User Line"

    sequence = fields.Integer(string='Sequence')
    user_id = fields.Many2one('res.users', string="User")
    approval_accounting_id = fields.Many2one('dsn.approval.accounting', string="Approver Accounting")

#  ================================\job ids\========================================>
class DsnAccountingApprovalJobLine(models.Model):
    _name = "dsn.accounting.approval.job.line"
    _description = "DSN Accounting Approval Job Line"
